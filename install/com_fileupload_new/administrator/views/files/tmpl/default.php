...
$canOrder	= $user->authorise('core.edit.state', 'com_fileupload');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_fileupload&task=files.saveOrderAjax&tmpl=component';
				...
				<td>
					...
					<?php
						if (!empty($item->filename)):
							$uploadPath = 'components' . DIRECTORY_SEPARATOR . 'com_fileupload' . DIRECTORY_SEPARATOR . 'F:\ftp' .DIRECTORY_SEPARATOR . $item->filename;
