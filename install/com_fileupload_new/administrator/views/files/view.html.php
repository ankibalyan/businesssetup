...
class FileuploadViewFiles extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        FileuploadHelper::addSubmenu('files');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_FILEUPLOAD_TITLE_FILES'), 'files.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_fileupload&view=files');
