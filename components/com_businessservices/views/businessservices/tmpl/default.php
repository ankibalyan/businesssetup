...
<?php 
	// echo "<pre>";
	// print_r($this->allDocs);
 //    echo "</pre>";
?>
<?php //BusinessServicesHelpersHelper::calenderEvents(); ?>
				...
				<div class="sfGrid-Col-10 col-centered">
					<div class="sfGrids">
						<div class="sfGrid-Col-4">
							<a href="<?php echo jRoute::_('index.php?option=com_businessservices&amp;layout=pending') ?>">
						...
						<div class="sfGrid-Col-4">
							<a href="<?php echo jRoute::_('index.php?option=com_businessservices&layout=completed') ?>">
								<div class="circle-text col-centered">
