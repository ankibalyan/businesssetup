...
<?php
        ...
        if(isset($_GET["params"])) {
         ...
         foreach ($resList as $list) :
          ...
          $no_of_promoters = 7 - $no_of_directors;
          $country_state =$list->country_state;
          $country_state =$list->country_state;
          $dirdetails =$list->dirdetails;
          $promoDetails = array('0' => 1,'1' => 2,'2' => 3, );
          ...
          $gov1 ='';
          $price1 ='';
          $desc1="Company Registration Public Limited ";
          $gov2 ='';
          $price2 ='';
...
{  
                                    ...
                                    $totalD;
                                    if($totalDir <= 7) {
                                      $totalExtraPromo = 7 - $totalDir;
                                    }
                                    else { $totalExtraPromo = 0; }
                                    $totalD = $totalDir + $totalExtraPromo;
                                    $display="block";
...
<?php for ($i=1; $i <= $totalDir ; $i++) {
    ...
    <?php } ?>
    <?php for ($j=$totalDir + 1, $i=1; $i <= $totalExtraPromo ; $j++,$i++) { ?>
    <li id="litab<?php echo$j; ?>" data-tabno="<?php echo "$j"; ?>" class="listtabs defaulttab" class="<?php echo$status ; ?>"  style="">
    <a id="ui-id-1" class="ui-tabs-anchor"  href="javascript:tabopen(<?php echo "$j"; ?>)" role="presentation" tabindex="-1">Promotor <?php echo $j ?> </a></li>
    <?php } ?>
...
<input type="text" id="directordin<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly value="<?php echo $list->director_din_file; ?>" /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="directordin<?php echo$i; ?>2" >update</a>
...
<td><input id="promotersshare<?php echo$i; ?>"   class=" <?php echo $validatefield; ?> " maxlength="3" name="promotersshare<?php echo$i; ?>" value="<?php echo $list1->promoters_percentage_of_share; ?>"  type="text" /><span  class="error_field">percentage in number</span></td>
</tr>
</table>
</div>
</div>
...
<input type="text" id="photograph<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly value="<?php echo $list->director_photograph_file; ?>" /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="photograph<?php echo$i; ?>2" >update</a>
...
<input type="text" id="pancard<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly value="<?php echo $list->director_pancard_file; ?>" /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="pancard<?php echo$i; ?>2" >update</a>
...
<input type="text" id="idprooffile<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly value="<?php echo $list->idproof_file; ?>" /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="idprooffile<?php echo$i; ?>2" >update</a>
...
<td><select id="addressproof<?php echo$i; ?>"
 name="addressproof<?php echo$i; ?>" >
...
<input type="text" id="addressprooffile<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly value="<?php echo $list->addressproof_file; ?>" /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="addressprooffile<?php echo$i; ?>2" >update</a>
...
<?php else:?>
<div id="tab<?php echo$i; ?>" class="tabs" >
<div class="PromoTab">
<table  id="dnp<?php echo$i; ?>" style="<?php echo $display;?>">
<tr>
<td>
<h3>Details of promoters <?php echo "$i"; ?></h3>
</td>
</tr>
<td>Name<span  style="color:red;">*</span></td>
<td><input id="promotersname<?php echo$i; ?>" class="<?php echo $validatefield; ?> " name="promotersname<?php echo$i; ?>" value="<?php echo $list1->promoters_name; ?>"  type="text" /><span  class="error_field">Enter Name</span></td>
...
<input type="text" id="directordin<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="directordin<?php echo$i; ?>2" >update</a>
...
<tr>
<td>% of share holding<span  style="color:red;">*</span></td> 
<td><input id="promotersshare<?php echo$i; ?>" maxlength="3" name="promotersshare<?php echo$i; ?>" value="" type="text" /><span  class="error_field">percentage in number</span></td>
</tr>
</table>
</div>
</div>
...
<td>
<?php   $fileinput="display:block"; $file="display:none"; $file="display:none"; $update="display:none";  ?>
<input type="text" id="photograph<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="photograph<?php echo$i; ?>2" >update</a>
<input id="photograph<?php echo$i; ?>" class="filevalidate" name="photograph<?php echo$i; ?>" type="file" />
<span  class="error_field" ></span><progress class="hideclass" id="photograph<?php echo$i; ?>prog" value="0" min ="0" max="100"></progress></td>
<td>PAN Card</td>
<td>
<?php   $fileinput="display:block"; $file="display:none"; $file="display:none"; $update="display:none";  ?>
<input type="text" id="pancard<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="pancard<?php echo$i; ?>2" >update</a>
...
<?php   $fileinput="display:block"; $file="display:none"; $file="display:none"; $update="display:none";  ?>
<input type="text" id="idprooffile<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="idprooffile<?php echo$i; ?>2" >update</a>
<input id="idprooffile<?php echo$i; ?>" class="filevalidate" name="idprooffile<?php echo$i; ?>" type="file" />
<span  class="error_field" ></span><progress class="hideclass" id="idprooffile<?php echo$i; ?>prog" value="0" min ="0" max="100"></progress></td>
<td><select id="addressproof<?php echo$i; ?>" name="addressproof<?php echo$i; ?>" >
<option value="" >Select Address</option>
<option value="1" >Mobile Bill</option>
<option value="2" >Electricity Bill</option>
<option value="3" >Telephone Bill</option>
...
<td>
<?php   $fileinput="display:block"; $file="display:none"; $file="display:none"; $update="display:none";  ?>
<input type="text" id="addressprooffile<?php echo$i; ?>" name="addressprooffile<?php echo$i; ?>" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="addressprooffile<?php echo$i; ?>2" >update</a>
...
<tr>
<td>Name<span  style="color:red;">*</span></td>
<td><input id="promotersname<?php echo$i; ?>" class="<?php echo $validatefield; ?> " name="promotersname<?php echo$i; ?>" value=""  type="text" /><span  class="error_field">Enter Name</span></td>
</tr>
<tr>
<td>Mail ID<span  style="color:red;">*</span></td>
<td><input id="promotersmail<?php echo$i; ?>"   class="<?php echo $validatefield; ?> " name="promotersmail<?php echo$i; ?>" value=""  type="text" /><span  class="error_field">Enter valid mail Id</span></td>
</tr>
<tr>
<td>% of share holding<span  style="color:red;">*</span></td>
<td><input id="promotersshare<?php echo$i; ?>"   class=" <?php echo $validatefield; ?> " maxlength="3" name="promotersshare<?php echo$i; ?>" value=""  type="text" /><span  class="error_field">percentage in number</span></td>
</tr>
</table>
</div>
<input id="cdnp<?php echo $i; ?>" data-value="<?php echo $i; ?>" class="cdnpclas" name="cdnp<?php echo$i; ?>" type="checkbox"    value="no" />
<input id="directorname<?php echo$i; ?>" name="directorname<?php echo$i; ?>" value=""  type="hidden" />
<input id="directorAddress<?php echo$i; ?>" name="directorAddress<?php echo$i; ?>" value=""  type="hidden" />
<input id="directorMail<?php echo$i; ?>" name="directorMail<?php echo$i; ?>" value=""  type="hidden" />
<input id="directorEducation<?php echo$i; ?>" name="directorEducation<?php echo$i; ?>" value=""  type="hidden" />
<input id="directorPlace<?php echo$i; ?>" name="directorPlace<?php echo$i; ?>" value="" type="hidden" />
<input type="hidden" id="directordin<?php echo$i; ?>1"  readonly  />
<input id="directordin<?php echo$i; ?>"   name="directordin<?php echo$i; ?>" type="hidden" />
<input id="dirshare<?php echo$i; ?>" maxlength="3" name="dirshare<?php echo$i; ?>" value=""  type="hidden" />

<input type="hidden" id="photograph<?php echo$i; ?>1" readonly  />
<input id="photograph<?php echo$i; ?>"  name="photograph<?php echo$i; ?>" type="hidden" />
<input type="hidden" id="pancard<?php echo$i; ?>1"  readonly  />
<input id="pancard<?php echo$i; ?>"  name="pancard<?php echo$i; ?>" type="hidden" />
<select id="idproof<?php echo$i; ?>" style ="display:none;" name="idproof<?php echo$i; ?>" >
<option value="" >Select Id</option>
<option value="1" >Passport</option>
<option value="2" >Aadhar Card</option>
<option value="3" >Election Card</option>
...
<input type="hidden" id="idprooffile<?php echo$i; ?>1"  readonly  />
<input id="idprooffile<?php echo$i; ?>"  name="idprooffile<?php echo$i; ?>" type="hidden" />
<select id="addressproof<?php echo$i; ?>" style ="display:none;" name="addressproof<?php echo$i; ?>" >
<option value="" >Select Address</option>
<option value="1" >Mobile Bill</option>
<option value="2" >Electricity Bill</option>
<option value="3" >Telephone Bill</option>
...
<input type="hidden" id="addressprooffile<?php echo$i; ?>1"  readonly  />
<input id="addressprooffile<?php echo$i; ?>"  name="addressprooffile<?php echo$i; ?>" type="hidden" />
</div>
  <?php endif; ?>
  <?php } ?>
</div>
<p><a class="button" class="ui-tabs-anchor" href="javascript:tabopen(<?php echo $totalD; ?>)" id="prevDir" role="presentation" tabindex="-1"> Prev Director</a>
<a class="button" class="ui-tabs-anchor" href="javascript:tabopen(2);" id="nextDir" role="presentation" tabindex="-1">Next Director</a>
<input type="submit" value="Proceed" /></p>
</form>
<p><span class="display_all_errors"></span></p>
...
<td><b><span style="text-decoration: underline;">Public Limited</span></b></td>
</tr>
<tr>
<td></td>
<td>1st Part</td>
...
<li class="cont">3rd Part Shall consist of Public Limited</li>
</ul>
</div>
<div style="clear: both;"></div>
