...
$lang->load('com_publiclc', JPATH_ADMINISTRATOR);
$serviceId=4;
?>
...
<article class="arc_section_main"><form id="publiclc_reg_form" action="<?php echo $this->baseurl; ?>/index.php/component/publiclc/registrationforms" method="post" name="privatelc_reg_form"> 
...
<tr>
<td>Directors *</td>
<td><select id="numdirectors" name="regService[numdirectors]">
...
<option value="5" data-info = "2"> 5 Lakhs</option>
<option value="10" data-info = "3">10 Lakhs</option>
<option value="15" data-info = "4">15 Lakhs</option>
<option value="20" data-info = "5">20 Lakhs</option>
</select>
<span class="error_field"></span>
</td>
</tr>
...
<div class="show_cont">
	<table class="private_pt">
		...
		<tbody>
			...
			<tr>
				<td class = "add_val">Form- INC 21</td>
				<td class = "add_val">100</td>
				<td class = "add_val">100</td>
				<td class = "add_val">100</td>
				<td class = "add_val">100</td>
			...
			<tr>
				<th>3. ROC Registration fee</th>
				<td class = "add_val">21000</td>
				<td class = "add_val">36000</td>
				<td class = "add_val">81000</td>
				<td class = "add_val">156000</td>
			</tr>
			<tr>
				<th>4. Form filing fees</th>
				<td class = "add_val"></td>
				<td class = "add_val"></td>
				<td class = "add_val"></td>
				<td class = "add_val"></td>
			...
			<tr>
				...
				<td class = "add_val">6000</td>
				<td class = "add_val">8000</td>
				<td class = "add_val">10000</td>
				<td class = "add_val">12000</td>
			</tr>
			<tr>
				<th>6. DIN Application fees</th>
				<td class = "add_val DIN">1500</td>
				<td class = "add_val DIN">1500</td>
				<td class = "add_val DIN">1500</td>
				<td class = "add_val DIN">1500</td>
			</tr>
			<tr>
				...
				<td class = "add_val DSF" data-base ="4500">4500</td>
				<td class = "add_val DSF" data-base ="4500">4500</td>
				<td class = "add_val DSF" data-base ="4500">4500</td>
				<td class = "add_val DSF" data-base ="4500">4500</td>
			</tr>
