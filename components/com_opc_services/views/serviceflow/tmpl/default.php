...
<?php
        ...
        if(isset($_GET["params"])) {
         ...
         foreach ($resList as $list) :
          ...
          $gov1 ='';
          $price1 ='';
          $desc1="Company Registration One Person ";
          $gov2 ='';
          $price2 ='';
  ...
  var id=0 , lastChar='';
    ...
    jQuery('.filevalidate').click(function () {
      ...
      if (fsize > 2024000) {
        ...
        jQuery(this).next('span.error_field').css('display', 'block').text("File must be smaller than 2MB.");
      } 
      else {
...
<td><b><span style="text-decoration: underline;">One Person</span></b></td>
</tr>
<tr>
<td></td>
<td>1st Part</td>
...
<li class="cont">3rd Part Shall consist of One Person</li>
</ul>
</div>
<div style="clear: both;"></div>
