 ...
 */
class Opc_servicesControllerRegistrationform extends Opc_servicesController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Registrationform', 'Opc_servicesModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_opc_services&view=registrationformform&layout=edit', false));
    }
