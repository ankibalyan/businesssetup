...
<br />
                                <div class="file-edit front-end-edit">
                                            ...
                                            <h3 style="float:left">Registration  Details </h3>
                                                ...
                                                <ul>
                                                    <li> &nbsp;<b> State :  </b><?php echo $list->country_state; ?>  &nbsp;&nbsp;<b>    No of Partners :  </b> <?php echo $list->no_of_directors; ?>      <b>  &nbsp;&nbsp;Share Capital : </b>
...
<?php for ($i=1; $i <= $totalDir ; $i++) {
    ...
    <a id="ui-id-1" class="ui-tabs-anchor"  href="javascript:void(0)" role="presentation" tabindex="-1">Partner <?php echo $i ?> </a></li>
    <?php } ?>
...
<tr>
<td colspan="2">
<h3>Edit Details of partner <?php echo$dirNo; ?></h3>
</td>
</tr>
<tr>
<td>Name of Partner<span  style="color:red;">*</span></td>
...
<tr>
<td>Address of partner<span  style="color:red;">*</span></td>
...
<tr>
<td>Mail Id of partner<span  style="color:red;">*</span></td>
...
<p><a class="button"  class="ui-tabs-anchor" href="javascript:tabopen(<?php echo $totalDir; ?>)" id="prevDir" role="presentation" tabindex="-1"> Prev Partner</a>
<a class="button" class="ui-tabs-anchor" href="javascript:tabopen(2);" id="nextDir" role="presentation" tabindex="-1">Next Partner</a>
...
<tr>
<td colspan="2">
<h3> Details of partner <?php echo$i; ?></h3>
</td>
</tr>
<tr>
<td>Name of Partner<span  style="color:red;">*</span></td>
...
<td>
<?php   $fileinput="display:block"; $file="display:none"; $file="display:none"; $update="display:none";  ?>
<input type="text" id="addressprooffile<?php echo$i; ?>1" style="<?php echo$file; ?>" readonly  /><a href="javascript:void(0);" style="<?php echo$update; ?>"  class="update" id="addressprooffile<?php echo$i; ?>2" >update</a>
