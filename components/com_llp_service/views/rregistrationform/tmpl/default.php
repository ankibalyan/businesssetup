...
$lang->load('com_llp_service', JPATH_ADMINISTRATOR);
$serviceId=2;
?>
...
<article class="arc_section_main"><form id="llp_reg_form" action="<?php echo $this->baseurl; ?>/index.php/component/llp_service/rregistrationforms" method="post" name="privatelc_reg_form"> 
...
<option value="0">No of Partners</option>
...
<tr>
<td>Capital *</td>
<td><select id="sharecapital" name="regService[sharecapital]">
<option value="" data-info = "0">Select Share Capital</option>
<option value="0" data-info = "2">Up to 10000</option>
<option value="1" data-info = "3">1 Lakh - 5 Lakhs</option>
<option value="6" data-info = "4">6 Lakhs - 10 Lakhs</option>
<option value="10" data-info = "5">Above 10 Lakhs</option>
</select>
<span class="error_field"></span>
</td>
</tr>
	...
	<table class="private_pt">
		...
		<tbody>
			...
			<tr>
				...
				<td class = "add_val DSF" data-base ="2000">2000</td>
				<td class = "add_val DSF" data-base ="2000">2000</td>
				<td class = "add_val DSF" data-base ="2000">2000</td>
				<td class = "add_val DSF" data-base ="2000">2000</td>
			</tr>
