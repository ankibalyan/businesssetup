...
<article class="arc_section_main"><form id="tm_reg_form" action="<?php echo $this->baseurl; ?>/index.php/component/trademark/trademarkforms" method="post" name="tm_reg_form"> 
