...
$jsFile = JURI::base(true).'/components/com_creativecontactform/assets/js/eye.js';
//$document->addScript($jsFile);

$jsFile = JURI::base(true).'/components/com_creativecontactform/assets/js/utils.js';
//$document->addScript($jsFile);
	...
	$(document).ready(function() {
		...
		$('.colorSelector').ColorPicker({
			...
			onChange: function (hsb, hex, rgb) {
				...
				//main wrapper
				if(roll == 0 || roll == 130) {
					$(".creativecontactform_wrapper").css('backgroundColor' , '#' + hex);
				...
				//field text///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$(".creativecontactform_field_name").css('color' , '#' + hex);
				}
				else if(roll == 37) {
					var textShadow = $("#elem-38").val() + 'px '  + $("#elem-39").val() + 'px '  + $("#elem-40").val() + 'px ' + $("#elem-37").val();
					$(".creativecontactform_field_name").css('textShadow' , textShadow);
				}
				//asterisk text///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				else if(roll == 41) {
				...
				//creativecontactform_send////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$(".creativecontactform_send").css('backgroundColor' , backColor_);

					var back = '-webkit-linear-gradient(top, ' + $("#elem-91").val() + ', '  + $("#elem-50").val() + ')';
					$(".creativecontactform_send").css('background' , back);
					...
					$(".creativecontactform_send").css('filter' , fil);
					...
					$(".creativecontactform_send").css('borderColor' , borderColor_);
					...
					$(".creativecontactform_send").css('boxShadow' , boxShadow_);
					...
					$(".creativecontactform_send").css('color' , textColor_);
					...
					$(".creativecontactform_send").css('textShadow' , textShadow_);
					...
					$(".creativecontactform_send").hover(function() {
						$(".creativecontactform_send").css('backgroundColor' , backColor);
					},function() {
						$(".creativecontactform_send").css('backgroundColor' , backColor_);
					});
				}
				...
				//creativecontactform text inputs////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					...
					$(".creativecontactform_input_element").not('.creative_error_input').css('background' , back);
					...
					$(".creativecontactform_input_element").not('.creative_error_input').css('filter' , fil);
					
					$(".creativecontactform_input_element").hover(function() {
					...
					$(".creativecontactform_input_element").not('.creative_error_input').css('borderColor' , borderColor);
					
					$(".creativecontactform_input_element").not('.creative_error_input').hover(function() {
						$(this).css('borderColor' , borderColor_);
					},function() {
						$(this).css('borderColor' , borderColor);
					});
					...
					$(".creativecontactform_input_element").not('.creative_error_input').css('boxShadow' , boxShadow);
					...
					$(".creativecontactform_input_element input,.creativecontactform_input_element textarea").css('color' , textColor);
					
					$(".creativecontactform_input_element input,.creativecontactform_input_element textarea").hover(function() {
						$(this).css('color' , textColor_);
					},function() {
						$(this).css('color' , textColor);
					});
					...
					$(".creativecontactform_input_element input,.creativecontactform_input_element textarea").css('textShadow' , textShadow);
		...
		function move_up(roll,val) {
			...
			//send///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				$(".creativecontactform_send").css('paddingTop' , val*1 + 1);
				$(".creativecontactform_send").css('paddingBottom' , val*1 + 1);
			}
			else if(roll == 93) {
				$(".creativecontactform_send").css('paddingLeft' , val*1 + 1);
				$(".creativecontactform_send").css('paddingRight' , val*1 + 1);
			}
			...
			//text inputs///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				var w = val*1 + 1 + '%';
				$(".creativecontactform_input_element").not('.creative_textarea_wrapper').css('width' , w);
			}
			else if(roll == 169) {
				var w = val*1 + 1 + '%';
				$(".creative_textarea_wrapper").css('width' , w);
			}
			else if(roll == 170) {
		...
		$("#elem-131").blur(function() {
			$(".creativecontactform_wrapper").css('fontFamily' , $(this).val());
		})
		...
		$("#elem-127").change(function() {
			var borderStyle = $(this).val();
			$(".creativecontactform_send").css('border' , $("#elem-101").val() + 'px ' +  borderStyle + $("#elem-100").val());
		})
		...
		$('.temp_block.opened').on('click',function() {
			$(this).removeClass('opened');
			$(this).addClass('closed');
			$(this).next('div').slideUp(600);
		})
		$('.temp_block.closed').on('click',function() {
			...
			<div class="creativecontactform_wrapper" >
 				<div class="creativecontactform_wrapper_inner">
 					<form class="creativecontactform_form">
			 			...
			 			<div  class="creativecontactform_pre_text">Contact us, if you have any questions</div>
			 			<div class="creative_title_holder">&nbsp;</div>
		 			
				 		<div class="creativecontactform_field_box">
				 			<label class="creativecontactform_field_name" for="name_0_1">Name <span class="creativecontactform_field_required">*</span></label>
				 			...
				 			<input type="hidden" name="creativecontactform_fields[1][1]" value="Name" />
				 		</div>
				 		<div class="creativecontactform_field_box">
				 			<label class="creativecontactform_field_name" for="email_0_2">Email</label>
				 			<div class="creativecontactform_input_element ">
					 			<div class="creative_input_dummy_wrapper">
					 				<input class="creative_email  creative_input_reset" value="" type="text" id="email_0_2" name="creativecontactform_fields[2][0]">
					 			</div>
				 			</div>
				 			<input type="hidden" name="creativecontactform_fields[2][1]" value="Email" />
				 		</div>
				 		<div class="creativecontactform_field_box creativecontactform_error">
				 			<label class="creativecontactform_field_name" for="phone_0_3">Phone (Error state)<span class="creativecontactform_field_required">*</span></label>
				 			<div class="creativecontactform_input_element creativecontactform_required creative_error_input">
				 				<div class="creative_input_dummy_wrapper">
				 					<input class="creative_phone  creative_input_reset creativecontactform_required" value="" type="text" id="phone_0_3" name="creativecontactform_fields[3][0]">
				 				</div>
				 			</div>
				 			<input type="hidden" name="creativecontactform_fields[3][1]" value="Phone" />
				 		</div>
				 		<div class="creativecontactform_field_box">
				 			<label class="creativecontactform_field_name" for="url_0_4">Website</label>
				 			<div class="creativecontactform_input_element ">
				 				<div class="creative_input_dummy_wrapper">
				 					<input class="creative_url  creative_input_reset" value="" type="text" id="url_0_4" name="creativecontactform_fields[4][0]">
				 				</div>
				 			</div>
				 			<input type="hidden" name="creativecontactform_fields[4][1]" value="Website" />
				 		</div>
				 		<div class="creativecontactform_field_box">
				 			<label class="creativecontactform_field_name" for="text-area_0_5">Message <span class="creativecontactform_field_required">*</span></label>
				 			...
				 			<input type="hidden" name="creativecontactform_fields[5][1]" value="Message" />
				 		</div>	 				
			 			<div class="creativecontactform_submit_wrapper">
			 				<input type="button" value="Send" class="creativecontactform_send" roll="1" />
			 				<div class="creativecontactform_clear"></div>
			 			</div>
			 			<div class="creativecontactform_clear"></div>
			 			<input type="hidden" name="0a619a037d1ff6923f1e097ba3170573" class="creativecontactform_token" value="1" />
			 			<input type="hidden" value="127.0.0.1"  name="creativecontactform_ip" />
			 			<input type="hidden" value="http://localhost/Joomla_3.1.1/index.php/creative-form"  name="creativecontactform_referrer" />
...
.creativecontactform_wrapper {
	...
	font-family: <?php echo $styles[131];?>
}
...
.creativecontactform_pre_text {
	...
	font-family: <?php echo $styles[202];?>;
