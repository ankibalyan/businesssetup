 ...
 */
class Opc_servicesViewServiceflows extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Opc_servicesHelper::addSubmenu('serviceflows');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_OPC_SERVICES_TITLE_SERVICEFLOWS'), 'serviceflows.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_opc_services&view=serviceflows');
