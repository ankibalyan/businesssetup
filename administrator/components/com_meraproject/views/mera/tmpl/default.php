...
$canOrder	= $user->authorise('core.edit.state', 'com_meraproject');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_meraproject&task=mera.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'meranamList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="meranamList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                $canEdit	= $user->authorise('core.edit',			'com_meraproject');
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'mera.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
