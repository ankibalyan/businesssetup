 ...
 */
class PubliclcViewServiceflows extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        PubliclcHelper::addSubmenu('serviceflows');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_PUBLICLC_TITLE_SERVICEFLOWS'), 'serviceflows.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_publiclc&view=serviceflows');
