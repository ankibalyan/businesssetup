 ...
 */
class PubliclcViewCustoms extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        PubliclcHelper::addSubmenu('customs');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_PUBLICLC_TITLE_CUSTOMS'), 'customs.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_publiclc&view=customs');
